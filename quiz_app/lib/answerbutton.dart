    ...
    return ElevatedButton(
      onPressed: onTap,style: ElevatedButton.styleFrom(
          ...
          shape:
              ...
              padding: EdgeInsets.symmetric(vertical: 10, horizontal: 40),), //! Make sure to use EdgeInsets.symmetric after using padding: then apecify vertical and horizontal padding 
